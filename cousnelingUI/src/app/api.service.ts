...
import { DeleteResponse } from "./ResponseClasses/deleteResponse";
import { AllMediaResponse } from "./ResponseClasses/getAllMediaResponse";
import { MakeAppointment } from "./ResponseClasses/makeAppointmentResponse";
import { InsertAvailability } from "./ResponseClasses/insertAvailability";
import { DeleteAvailability } from "./ResponseClasses/deleteAvailabilityResponse";
...
export class ApiService {
  ...
  updateRating( data ) {
    return this.httpclient.put <any>( environment.bookingApi, data);
  }
